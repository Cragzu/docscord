...
![Settings icon in Discord](https://github.com/Cragzu/docscord/blob/master/assets/images/locate_settings_gear.png?raw=true)

Scroll through the options on the left side, and click on **Voice & Video**.

![Voice & Video menu item](https://github.com/Cragzu/docscord/blob/master/assets/images/locate_voice_video_settings_tab.png?raw=true)
...
![Select your input device](https://github.com/Cragzu/docscord/blob/master/assets/images/select_input_device.jpg?raw=true)
...
![Voice Activity settings](https://github.com/Cragzu/docscord/blob/master/assets/images/voice_activity.png?raw=true)
...
![Push to Talk settings](https://github.com/Cragzu/docscord/blob/master/assets/images/push_to_talk.png?raw=true)
...
![Create DM button](https://github.com/Cragzu/docscord/blob/master/assets/images/create_dm_button.png?raw=true)
...
![Add friends to DM](https://github.com/Cragzu/docscord/blob/master/assets/images/dm_select_friends.png?raw=true)
...
![Start a call in DM](https://github.com/Cragzu/docscord/blob/master/assets/images/start_dm_call.png?raw=true)
...
![Join a call in DM](https://github.com/Cragzu/docscord/blob/master/assets/images/join_dm_call.jpg?raw=true)
...
![Icon meanings in DM call](https://github.com/Cragzu/docscord/blob/master/assets/images/dm_call_iconography.png?raw=true)
...
![Exit DM call](https://github.com/Cragzu/docscord/blob/master/assets/images/dm_leave_call.png?raw=true)
...
[make your own](http://chloe-glave.codes/docscord/docs/making-a-server/)?
...
![Discord server list](https://github.com/Cragzu/docscord/blob/master/assets/images/server_list.png?raw=true)
...
![Discord channel list](https://github.com/Cragzu/docscord/blob/master/assets/images/server_channel_list.png?raw=true)
...
![Adjust user volume](https://github.com/Cragzu/docscord/blob/master/assets/images/adjust_user_volume.png?raw=true)

---
### c) Exiting a voice channel

Once you’re all done talking, you’ll need to leave the channel. Similarly to a 
[Direct Message call](http://chloe-glave.codes/docscord/docs/using-voice-chat/#d-exiting-a-call), 
...
![Leave server voice channel](https://github.com/Cragzu/docscord/blob/master/assets/images/server_vc_disconnect.png?raw=true)
...
the [Troubleshooting](http://chloe-glave.codes/docscord/docs/troubleshooting/) page. Good luck, and have fun!
